...
public final class PurchaseFlow implements CancellableRequestListener<PendingIntent> {
	...
	PurchaseFlow( Activity activity, int requestCode,  RequestListener<Purchase> listener,  PurchaseVerifier verifier) {
	...
	@Override
	public void onSuccess( PendingIntent purchaseIntent) {
		if (listener == null) {
