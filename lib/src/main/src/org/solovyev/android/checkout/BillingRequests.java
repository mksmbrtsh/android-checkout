...
public interface BillingRequests {
	 ...
	 */
	int isBillingSupported( String product);
	 ...
	 * @see org.solovyev.android.checkout.ProductTypes
	 */
	int isBillingSupported( String product,  RequestListener<Object> listener);
	 ...
	 * @see org.solovyev.android.checkout.ProductTypes
	 */
	int getPurchases( String product,  String continuationToken,  RequestListener<Purchases> listener);

	/**
	 * Same as {@link #getPurchases(String, String, RequestListener)} but will load all the purchases.
	 */
	int getAllPurchases( String product,  RequestListener<Purchases> listener);
	 ...
	 * @return request id
	 */
	int isPurchased( String product,  String sku,  RequestListener<Boolean> listener);
	 ...
	 * @return request id
	 */
	int getSkus( String product,  List<String> skus,  RequestListener<Skus> listener);
	 ...
	 * @return request id
	 */
	int purchase( String product,  String sku,  String payload,  PurchaseFlow purchaseFlow);

	int purchase( Sku sku,  String payload,  PurchaseFlow purchaseFlow);
	 ...
	 * @return request id
	 */
	int consume( String token,  RequestListener<Object> listener);
