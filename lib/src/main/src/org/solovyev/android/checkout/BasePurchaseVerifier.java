...
public abstract class BasePurchaseVerifier implements PurchaseVerifier {
	...
	@Override
	public final void verify( final List<Purchase> purchases,  final RequestListener<List<Purchase>> listener) {
	 ...
	 */
	protected abstract void doVerify( List<Purchase> purchases,  RequestListener<List<Purchase>> listener);
	...
	private final class MainThreadRequestListener implements RequestListener<List<Purchase>> {
		...
		@Override
		public void onSuccess( final List<Purchase> result) {
		...
		@Override
		public void onError(final int response,  final Exception e) {
			mainThread.execute(new Runnable() {
				@Override
				public void run() {
