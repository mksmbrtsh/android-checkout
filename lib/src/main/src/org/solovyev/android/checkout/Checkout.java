 ...
 *                  }
 * <p/>
 *                  public void onReady( BillingRequests requests,  String product, boolean billingSupported) {
 *                      if (billingSupported) {
...
public class Checkout {
	...
	public static ActivityCheckout forActivity( Activity activity,  Billing billing,  Products products) {
		return new ActivityCheckout(activity, billing, products);
	}

	
	public static ActivityCheckout forActivity( Activity activity,  Checkout checkout) {
		return new ActivityCheckout(activity, checkout.billing, checkout.products);
	}

	
	public static Checkout forService( Service service,  Billing billing,  Products products) {
		return new Checkout(service, billing, products);
	}

	
	public static Checkout forApplication( Billing billing,  Products products) {
	...
	public static interface Listener {
		 ...
		 */
		void onReady( BillingRequests requests);
		 ...
		 */
		void onReady( BillingRequests requests,  String product, boolean billingSupported);
	}
	...
	Checkout( Context context,  Billing billing,  Products products) {
	...
	public void whenReady( Listener listener) {
		Check.isMainThread();
	...
	private void onBillingSupported( String product, boolean supported) {
		synchronized (lock) {
	...
	public boolean isBillingSupported( String product) {
