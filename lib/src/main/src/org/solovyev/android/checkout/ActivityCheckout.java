...
public final class ActivityCheckout extends Checkout {
	...
	ActivityCheckout(final Activity activity, Billing billing, Products products) {
	 ...
	 */
	public void createPurchaseFlow(RequestListener<Purchase> listener) {
	 ...
	 */
	public void createPurchaseFlow(int requestCode, RequestListener<Purchase> listener) {
	...
	public PurchaseFlow createOneShotPurchaseFlow( RequestListener<Purchase> listener) {
	...
	public PurchaseFlow createOneShotPurchaseFlow(int requestCode,  RequestListener<Purchase> listener) {
		return createPurchaseFlow(requestCode, listener, true);
	}

	
	private PurchaseFlow createPurchaseFlow(final int requestCode,  RequestListener<Purchase> listener, boolean oneShot) {
